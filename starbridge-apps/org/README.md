...
This crate is the dregg-native successor of `./dreggnet/org` (`DREGGNET-MIGRATION.md`
...
attenuated owner grant` bridge are ported natively here. **`./dreggnet/org` can be
deleted.**
