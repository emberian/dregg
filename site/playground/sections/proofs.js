...
export function initProofs(wasm) {
  ...
  container.innerHTML = `
    <div class="section-header">
      ...
      <a href="/starbridge.html?at=pyana://proof/demo" target="_blank" style="font-size:0.8em;float:right;">Open in Starbridge &lt;pyana-proof&gt; (deep link) →</a>
      <p>
      ...
      <div style="background:#fff8e6;border:1px solid #f0d080;padding:0.25rem 0.5rem;font-size:0.75rem;margin:0.3rem 0;">
        <strong>§4.9 Migration:</strong> Superseded by platform <code>&lt;pyana-proof&gt;</code> inspector (trust-tier, real views). Tamper demo preserved here (learn carve-out). 
        <a href="/starbridge.html?at=pyana://proof/demo" target="_blank">Deep-link to Starbridge now →</a>
      </div>
